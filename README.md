...
### Download Zip:
[Click here to download a zip file](https://github.com/nyahoon-games/ProjectorForLWRP/archive/master.zip) and extract it in your Assets folder.
...
| Prevent overwriting | If this option is checked, stencil test will never improve the performance. Instead, it prevents drawing the projection more than once on the same pixel, which could happen if there are transparent objects in the projector frustom. |
