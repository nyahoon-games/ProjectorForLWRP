...
{
    public static class P4LWRPShaderKeywords
    {
        // ------------------------------
        // Projector Keywords
        // ------------------------------
        ...
        public enum ShadowLightSource
        {
            MainLight = 0,
            AdditionalLight = 1,
            AdditionalVertexLight = 2
        }
        static readonly string[] ADDITIONAL_LIGHT_SHADOW_KEYWORDS = { null, "P4LWRP_ADDITIONAL_LIGHT_SHADOW", "P4LWRP_ADDITIONAL_VERTEX_LIGHT_SHADOW" };
        ...
        static P4LWRPShaderKeywords()
        {
            ...
            ShaderUtils.ShaderKeywordGroup<ShadowLightSource>.s_keywords = ADDITIONAL_LIGHT_SHADOW_KEYWORDS;
